...
# L8 Fock-basis cavity-QED HEG run on one GH200.
#
# Usage:
#   sbatch --job-name=<name> \
#          --output=runs/<project>.slurm.out \
#          --error=runs/<project>.slurm.err \
#          scripts/slurm_qed/run_fock.sh inputs/2dheg_qed/<config>.yaml
...
python scripts/run_qed_fock_heg.py "$YAML"
