...
The 16 unit tests in \texttt{tests/test\_cs\_transition.py},
\texttt{tests/test\_cs\_mrpt\_multistate.py}, and
\texttt{tests/test\_vmcopt\_nn\_pfau.py} validate the rotation,
transition, NEVPT2, and Pfau-NES routines against PySCF's own
\texttt{trans\_rdm1s} and \texttt{NEVPT} reference implementations
and against analytic invariants (rotation idempotence on already-
orthogonal inputs; determinantal collapse to zero at
identical-state limit).
