...
\begin{tabular}{lcccc}
\hline
Active space & $E_{\rm CASCI}^{\rm exc}$ (Ha) &
$E_{\rm PT2}^{\rm exc}$ (mE$_h$) &
match-overlap${}^{\rm exc}$ &
$\Delta E_{\rm CAS+PT2}$ (eV) \\
\hline
CAS(8,(4,4))    & $-75.683$ & $-235$ & $0.48$ & $9.97$ \\
CAS(12,(4,4))   & $-75.683$ & $-201$ & $0.48$ & $9.63$ \\
CAS(16,(4,4))   & TBD       & TBD    & TBD    & TBD    \\
CAS(20,(4,4))   & TBD       & TBD    & TBD    & TBD    \\
\hline
\end{tabular}
\end{table}

The TBD entries are produced by SLURM jobs 5237 (CAS(16)) and
5238 (CAS(20)) on the same FermiNet+J K=4 checkpoint; we expect
the match-overlap to plateau in the $0.7$--$0.9$ range as the CAS
``learns'' the recovered NN state's full structure.
