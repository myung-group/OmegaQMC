...
vs $5.2$\,m$E_{\rm h}$ for CASSCF+NEVPT2. The strongly-correlated
\ce{C2}/cc-pVDZ case ($|c_{\rm ref}|^{2} \approx 0.7$ at FCI) is
expected to show a larger advantage at small active spaces, since
multireference character strains the CASSCF reference more severely;
those numbers are pending the C$_2$ training and recovery. A previously reported pilot on
