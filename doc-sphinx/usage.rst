...
:func:`~OmegaQMC.psi.gto.extract_casscf_trial` converts a converged
...
wavefunction using :func:`~OmegaQMC.psi.gto.extract_casscf_trial`:
...
same :func:`~OmegaQMC.psi.gto.extract_casscf_trial` call can feed
