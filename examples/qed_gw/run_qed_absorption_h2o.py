"""Cavity absorption of H2O/cc-pVDZ at three levels of QED theory.

Three side-by-side spectra of water in an optical cavity, lambda-scanned
...
(a) QED-RPA               -- photon explicit in the RPA excitation space,
                             cavity tuned to the lowest bright RPA root
                             (omega_cav = 0.415668 Ha = 11.31 eV).
(b) static QED-BSE@GW      -- photon enters only through the screened
                             ...
                             bright exciton shifts smoothly with lambda but
                             cannot Rabi-split.
(c) polaritonic QED-BSE@GW -- photon placed explicitly in the BSE
                             excitation manifold (photon kept out of W to
                             avoid double counting); the bright exciton
                             Rabi-splits into lower/upper polaritons.

Both BSE panels share one cavity frequency, retuned (at lambda = 0, where
